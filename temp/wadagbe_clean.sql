...
CREATE SCHEMA IF NOT EXISTS `wadagbe` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `wadagbe` ;

-- -----------------------------------------------------
-- Table `wadagbe`.`pages`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`pages` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`utilisateurs`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`utilisateurs` (
  ...
  `cle_activation` VARCHAR(100) NOT NULL ,
  `statut` INT NULL DEFAULT 1 COMMENT '1 - actif\n2 - supprimé' ,
  PRIMARY KEY (`id_utilisateurs`) ,
  UNIQUE INDEX `mail_UNIQUE` (`courriel` ASC) ,
  UNIQUE INDEX `username_UNIQUE` (`nom_utilisateur` ASC) )
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `wadagbe`.`evaluation`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`evaluation` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`categorie`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`categorie` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`produits`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`produits` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`adresse`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`adresse` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`adresse_utilisateur`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`adresse_utilisateur` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`commandes`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`commandes` (
...
-- -----------------------------------------------------
-- Table `wadagbe`.`commande_produit`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`commande_produit` (
...
-- Table `wadagbe`.`menu`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `wadagbe`.`menu` (
